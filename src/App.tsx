...
function Home() {
  ...
  return <><Header /><main>
    ...
    <section className="evergreen-tools"><div className="section-heading"><div><span className="eyebrow">Matemáticas esenciales</span><h2>Calculadoras para todo el año</h2></div><p>Fórmulas, procedimiento y resultados listos para comprobar.</p></div><div className="guide-links"><a href="/calculadora-regla-de-tres">Regla de tres paso a paso <ArrowRight /></a><a href="/media-mediana-moda">Media, mediana, moda y desviación <ArrowRight /></a><a href="/calculadora-areas-perimetros">Áreas y perímetros <ArrowRight /></a><a href="/calculadora-volumenes">Volúmenes de figuras <ArrowRight /></a><a href="/calculadora-dias-entre-fechas">Días entre fechas <ArrowRight /></a><a href="/generador-tablas-multiplicar">Tablas para practicar <ArrowRight /></a></div></section>
